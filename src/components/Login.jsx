...
export default function Login() {
    ...
    return (
        <div className='flex justify-center relative top-5'>
            <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6 md:p-8 dark:bg-blue-300 dark:border-blue-200">
                <form className="space-y-6" onSubmit={submit} action="#">
                    <h5 className="text-xl font-medium text-gray-900 dark:text-white">Login in to our platform</h5>
                    <div>
                    ...
                    <div className="text-sm font-medium text-gray-600 dark:text-gray-200">
                        Not Activate? <a href="/Signup" className="text-blue-700 hover:underline dark:text-blue-700">sign-up</a>
                    </div>
                </form>
            </div>
        </div>
